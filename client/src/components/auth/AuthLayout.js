  ...
  const features = [
    {
      ...
      description: "Improve your speaking skills through live video sessions, interactive exercises, and instant pronunciation feedback from anywhere.",
      icon: (
    ...
    },
    {
      ...
      description: "Access structured learning materials tailored to your proficiency level, with clear progression tracking and achievement milestones.",
      icon: (
        <svg className="w-6 h-6 text-blue-900" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Get immediate feedback on your pronunciation, speaking pace, and language proficiency with our advanced assessment tools.",
      icon: (
        <svg className="w-6 h-6 text-blue-900" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Join a supportive community of learners, practice speaking with peers, and build confidence in a safe learning environment.",
      icon: (
        <svg className="w-6 h-6 text-blue-900" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="relative max-w-2xl z-10">
            ...
            >
              <p className="text-gray-900 italic font-medium">
                "Start your English speaking journey today with our innovative learning platform designed to help you achieve fluency with confidence."
              </p>
            </motion.div>
          </div>
